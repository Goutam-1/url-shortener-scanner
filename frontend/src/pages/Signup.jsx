  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 bg-gray-50">
      <div className="w-full max-w-sm bg-white p-8 rounded-2xl border border-gray-100 shadow-sm animate-fade-in-up">
        <h1 className="font-display text-2xl font-bold text-gray-900 text-center mb-1">Create account</h1>
        <p className="text-sm text-gray-500 text-center mb-6">Start shortening and tracking links</p>
